package com.example.meetingminutes.animation;
...
public class ZoomImageAnimation {
    ...
    public void ZoomImageAnimation( int imageResId, final ImageView expandedImageView, final FrameLayout frameLayout, AdapterView.OnItemClickListener context, View view) {
